...
public class StoneSmoke {
    ...
    public void Draw(Graphics2D g2d)
    {
        ...
        int newImageXCoordinate = (int)(smokeImg.getWidth()/2 * (1-imageTransparency)); // We will set new y coordinate of smoke so that its stays in center behind the rocket.
        g2d.drawImage(smokeImg, xCoordinate - newImageXCoordinate, yCoordinate, newImageWidth, newImageHeight, null);
